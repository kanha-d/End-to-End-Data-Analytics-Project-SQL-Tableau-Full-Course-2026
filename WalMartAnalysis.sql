...
LIMIT 10;   -- Change 10 to any N value

UPDATE sales
SET `date` = STR_TO_DATE(
    CONCAT(
        IF(RAND() < 0.5, '2024', '2025'),
...
'/Users/kanhaiyaagrawal/Downloads/WalmartSalesData.csv'
INTO TABLE sales
...
-- Since invoice_id is the Primary Key, duplicates shouldn't exist, but it's a good validation step.
...
-- Sometimes CSVs contain blank strings instead of NULL.
